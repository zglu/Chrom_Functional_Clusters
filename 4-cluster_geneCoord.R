...
p<-p + geom_segment(data=segms, aes(x=chr, xend=chr, y=start/1000000, yend=end/1000000, colour=func), size=9) + geom_text_repel(data=segms, mapping=aes(x=chr, y=(start/1000000+end/1000000)/2, label=paste0(name, " (", genes, ")")), size=2.0, vjust=-1.5, hjust=-0.1, color="black") + theme_bw() 
